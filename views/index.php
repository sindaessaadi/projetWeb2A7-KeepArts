                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
                        <h4> <?php echo $event["nom_event"]; ?>
</h4>
                        <span><?php echo $event["nom_event"]; ?></span>
                        <div class="main-button">
                          <a href="addTicket.php?id=<?php echo $event["id_event"]; ?>">Reserve</a>
                        </div>
                        <p><?php echo $event["description"]; ?></p>
                        <ul class="info">
                          <li><i class="fa fa-user"></i><?php echo $event["nb_palces"]; ?> Places</li>
                          <li><i class="fa fa-globe"></i><?php echo $event["lieu"]; ?></li>
                          <li><i class="fa fa-home"></i><?php echo $event["date"]; ?></li>
                        </ul>
