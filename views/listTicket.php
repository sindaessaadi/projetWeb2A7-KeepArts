          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"><?= $ticket['enom']; ?></span>
                  <h4><?= $ticket['dateexpiration']; ?></h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-clock"></i>
                      <span class="list"><?= $ticket['cvv']; ?></span>
                    </div>
                    <div class="col-6">
                      <i class="fa fa-map"></i>
                      <span class="list"><?= $ticket['numcarte']; ?></span>
                    </div>
                  </div>
                 
                  <div class="main-button">
                  <a href="QrCode.php?id=<?php echo $ticket['id']; ?>">Generate QrCode</a>
                    <a href="updateTicket.php?id=<?php echo $ticket['id']; ?>">Edit</a>
                    <a href="DeleteTicket.php?id=<?php echo $ticket['id']; ?>">Delete</a>
                  </div>
                </div>
              </div>
            </div>
