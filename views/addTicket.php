...
$ticketC = new TicketC();
if (
    isset($_POST["dateexpiration"]) &&!empty($_POST['dateexpiration'])&&
    isset($_POST["cvv"]) &&!empty($_POST["cvv"])&&
    isset($_POST["numcarte"]) &&!empty($_POST["numcarte"])
    )
    {
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                  <fieldset>
                      ...
                      <input type="date" name="dateexpiration" class="Name"  autocomplete="on" required>
                  </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="Number" class="form-label">Numero Carte</label>
                    <input type="text" name="numcarte" class="Number"  autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="Number" class="form-label">CVV</label>
                    <input type="text" name="cvv" class="Number"  autocomplete="on" required>
                </fieldset>
              </div>
